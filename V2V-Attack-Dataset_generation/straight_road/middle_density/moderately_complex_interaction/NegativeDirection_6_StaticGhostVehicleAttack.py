"""Straight-road scenario 01 middle-density run: six negative-direction vehicles with static ghost vehicle attack."""
...
CASE_NAME = "NegativeDirection_6_StaticGhostVehicleAttack"
