"""Straight-road scenario 01 middle-density run: six negative-direction vehicles with false information injection attack."""
...
CASE_NAME = "NegativeDirection_6_FalseInformationInjection"
