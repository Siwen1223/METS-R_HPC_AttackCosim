"""Straight-road scenario 01 middle-density complicated interaction: six negative-direction vehicles with obstacle ghost vehicle attack and overtaking lane changes enabled."""
...
CASE_NAME = "NegativeDirection_6_ComplicatedLaneChange_ObstacleGhostVehicleAttack"
...
def build_attack(controller_vids, run_start_tick):
    ...
    attack = ObstacleGhostVehicleAttack(
        target_vehicle_id=controller_vids[2],
        ghost_id=None,
