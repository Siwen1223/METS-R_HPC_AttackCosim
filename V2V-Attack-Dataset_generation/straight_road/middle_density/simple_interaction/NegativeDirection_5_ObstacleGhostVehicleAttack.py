"""Straight-road scenario 02 middle-density run: five negative-direction vehicles with obstacle ghost vehicle attack."""
...
CASE_NAME = "NegativeDirection_5_ObstacleGhostVehicleAttack"
...
def build_attack(controller_vids, run_start_tick):
    ...
    attack = ObstacleGhostVehicleAttack(
        target_vehicle_id=controller_vids[0],
        ghost_id=None,
