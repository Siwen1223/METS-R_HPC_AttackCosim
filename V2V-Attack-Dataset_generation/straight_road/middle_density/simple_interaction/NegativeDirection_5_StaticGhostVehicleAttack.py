"""Straight-road scenario 02 middle-density run: five negative-direction vehicles with static ghost vehicle attack."""
...
CASE_NAME = "NegativeDirection_5_StaticGhostVehicleAttack"
