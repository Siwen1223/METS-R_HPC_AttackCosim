"""Straight-road scenario 02 middle-density run: five negative-direction vehicles with false information injection attack."""
...
CASE_NAME = "NegativeDirection_5_FalseInformationInjection"
SCENARIO_PATH = ROOT_DIR / "V2V-Attack-Dataset/scenarios/straight_road/straight_road_scenario_02.yaml"
DATASET_ROOT = ROOT_DIR / "V2V-Attack-Dataset"
MOVEMENT_NAMES = ("negative", "negative", "negative", "negative", "negative")
CAMERA_HEIGHT = 220
RANDOM_SEED = 42
...
def build_attack(controller_vids, run_start_tick):
    ...
    attack = FalseInformationInjectionAttack(
        attacker_vehicle_id=controller_vids[2],
