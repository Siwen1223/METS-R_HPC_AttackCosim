"""On-ramp scenario 01 middle-density simple interaction: five vehicles with false information injection attack."""
...
CASE_NAME = "OnRamp_5_FalseInformationInjection"
...
MOVEMENT_NAMES = ("on_ramp", "mainline", "mainline", "mainline", "mainline")
LANE_PATHS = {
    1: ["2_2", "45_2", "-29#0_2"],
    2: ["-16_2", "-25_2", "-28_2", "-29#0_2"],
    3: ["-16_2", "-25_2", "-28_2", "-29#0_2"],
    4: ["-16_2", "-25_2", "-28_2", "-29#0_2"],
    5: ["-16_2", "-25_2", "-28_2", "-29#0_2"],
}
