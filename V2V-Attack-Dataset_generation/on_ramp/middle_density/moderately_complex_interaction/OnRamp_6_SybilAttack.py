"""On-ramp scenario 01 middle-density moderately complex interaction: six vehicles with sybil attack."""
...
from cosim_utils.attack_manager import SybilAttack, V2XAttackManager, assign_attack_vehicle_ids
...
CASE_NAME = "OnRamp_6_SybilAttack"
