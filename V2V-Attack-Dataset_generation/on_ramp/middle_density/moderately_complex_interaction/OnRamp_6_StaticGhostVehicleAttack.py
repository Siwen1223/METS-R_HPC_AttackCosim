"""On-ramp scenario 01 middle-density moderately complex interaction: six vehicles with static ghost vehicle attack."""
...
CASE_NAME = "OnRamp_6_StaticGhostVehicleAttack"
...
def build_attack(controller_vids, run_start_tick, scenario):
    ...
    target_vid = controller_vids[MAINLINE_FIRST_INDEX]
    attack = StaticGhostVehicleAttack(
        target_vehicle_id=target_vid,
        ghost_id=None,
        scenario_type="merging",
        merging_point_center_xy_carla=scenario.get("merging_point_center_xy_carla"),
        speed_mps=0.0,
