"""On/off-ramp scenario 01 middle-density complicated interaction: six vehicles with sybil attack."""
...
CASE_NAME = "OnOffRamp_6_SybilAttack"
...
def build_attack(controller_vids, run_start_tick, scenario):
    ...
    attack = SybilAttack(
        ...
        sybil_count=5,
        offsets_xy=[(10.0, 0.0), (18.0, 0.0), (26.0, 0.0), (14.0, -3.5), (22.0, 3.5)],
