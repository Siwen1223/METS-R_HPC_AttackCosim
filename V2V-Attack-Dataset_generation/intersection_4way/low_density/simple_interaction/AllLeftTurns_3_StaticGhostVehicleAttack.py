"""Scenario 02 low-density simple interaction: all vehicles turn left with static ghost attack."""
...
CASE_NAME = "AllLeftTurns_3_StaticGhostVehicleAttack"
...
MOVEMENT_NAMES = ("north_to_east", "north_to_east", "north_to_east")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
TRAFFIC_DENSITY = "low"
