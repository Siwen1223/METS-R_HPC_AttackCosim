"""Scenario 02 low-density simple interaction: one left turn and one right turn with false information attack."""
...
CASE_NAME = "LeftAndRight_2_FalseInformationInjection"
SCENARIO_PATH = ROOT_DIR / "V2V-Attack-Dataset/scenarios/intersection_4way/intersection_4way_scenario_02.yaml"
DATASET_ROOT = ROOT_DIR / "V2V-Attack-Dataset"
MOVEMENT_NAMES = ("north_to_east", "north_to_west")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
TRAFFIC_DENSITY = "low"
WEATHER = "clear"
