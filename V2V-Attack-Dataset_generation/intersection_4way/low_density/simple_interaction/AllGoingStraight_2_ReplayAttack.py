"""Scenario 02 low-density simple interaction: all vehicles go straight with replay attack."""
...
CASE_NAME = "AllGoingStraight_2_ReplayAttack"
...
REPLAY_RECORD_PATH = DATASET_ROOT / "replay_records/intersection_4way/intersection_4way_scenario_02/east_to_west.jsonl"
MOVEMENT_NAMES = ("north_to_south", "north_to_south")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
TRAFFIC_DENSITY = "low"
