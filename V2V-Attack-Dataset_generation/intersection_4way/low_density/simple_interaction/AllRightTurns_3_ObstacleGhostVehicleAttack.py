"""Scenario 02 low-density simple interaction: all vehicles turn right with obstacle ghost attack."""
...
CASE_NAME = "AllRightTurns_3_ObstacleGhostVehicleAttack"
...
MOVEMENT_NAMES = ("north_to_west", "north_to_west", "north_to_west")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
TRAFFIC_DENSITY = "low"
