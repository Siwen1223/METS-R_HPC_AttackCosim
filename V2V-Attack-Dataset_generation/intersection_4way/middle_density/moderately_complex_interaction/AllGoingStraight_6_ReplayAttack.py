"""Scenario 01 middle-density interaction: vehicles from north and east all go straight with replay attack."""
...
MOVEMENT_NAMES = ("north_to_south", "north_to_south", "north_to_south", "east_to_west", "east_to_west", "east_to_west")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
