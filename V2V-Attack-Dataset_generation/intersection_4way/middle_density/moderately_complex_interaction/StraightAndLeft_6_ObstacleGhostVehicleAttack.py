"""Scenario 01 middle-density interaction: one direction straight and one direction left with obstacle ghost attack."""
...
CASE_NAME = "StraightAndLeft_6_ObstacleGhostVehicleAttack"
