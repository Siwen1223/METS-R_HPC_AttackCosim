"""Scenario 01 middle-density interaction: vehicles from north and south all turn left with static ghost attack."""
...
MOVEMENT_NAMES = ("north_to_east", "north_to_east", "north_to_east", "south_to_west", "south_to_west", "south_to_west")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
