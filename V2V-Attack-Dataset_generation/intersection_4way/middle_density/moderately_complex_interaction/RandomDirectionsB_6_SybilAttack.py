"""Scenario 01 middle-density interaction: fixed random movements from east and south with sybil attack."""
...
MOVEMENT_NAMES = ("east_to_north", "east_to_west", "east_to_south", "south_to_east", "south_to_north", "south_to_west")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
