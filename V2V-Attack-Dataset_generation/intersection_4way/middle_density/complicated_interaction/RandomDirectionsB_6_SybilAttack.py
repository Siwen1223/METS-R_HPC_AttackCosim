"""Scenario 03 middle-density complicated interaction: second fixed random movement set from four directions with sybil attack."""
...
CASE_NAME = "RandomDirectionsB_6_SybilAttack"
...
MOVEMENT_NAMES = ("north_to_south", "east_to_north", "south_to_west", "west_to_south", "east_to_west", "south_to_east")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
...
def build_attack(controller_vids, run_start_tick):
    ...
    attack = SybilAttack(
        attacker_vehicle_id=controller_vids[3],
        sybil_count=5,
