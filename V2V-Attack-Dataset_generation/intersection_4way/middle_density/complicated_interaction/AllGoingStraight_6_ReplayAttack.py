"""Scenario 03 middle-density complicated interaction: vehicles from three directions all go straight with replay attack."""
...
CASE_NAME = "AllGoingStraight_6_ReplayAttack"
...
REPLAY_RECORD_PATH = DATASET_ROOT / "replay_records/intersection_4way/intersection_4way_scenario_03/north_to_south.jsonl"
MOVEMENT_NAMES = ("north_to_south", "north_to_south", "east_to_west", "east_to_west", "west_to_east", "west_to_east")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
