"""Scenario 03 middle-density complicated interaction: fixed random movements from four directions with obstacle ghost vehicle attack."""
...
CASE_NAME = "RandomDirectionsA_5_ObstacleGhostVehicleAttack"
