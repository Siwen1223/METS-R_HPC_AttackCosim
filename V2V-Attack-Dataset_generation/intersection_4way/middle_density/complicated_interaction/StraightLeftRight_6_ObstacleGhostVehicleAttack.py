"""Scenario 03 middle-density complicated interaction: one straight, one left, and one right flow with obstacle ghost attack."""
...
CASE_NAME = "StraightLeftRight_6_ObstacleGhostVehicleAttack"
...
MOVEMENT_NAMES = ("north_to_south", "north_to_south", "east_to_south", "east_to_south", "west_to_south", "west_to_south")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
