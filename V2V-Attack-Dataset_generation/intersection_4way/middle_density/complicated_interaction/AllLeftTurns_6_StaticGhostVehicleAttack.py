"""Scenario 03 middle-density complicated interaction: vehicles from three directions all turn left with static ghost attack."""
...
CASE_NAME = "AllLeftTurns_6_StaticGhostVehicleAttack"
...
MOVEMENT_NAMES = ("north_to_east", "north_to_east", "east_to_south", "east_to_south", "south_to_west", "south_to_west")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
