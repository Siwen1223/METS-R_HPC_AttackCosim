"""Record roundabout scenario 01 south-to-west movement as replayable BSM data."""
...
from cosim_utils.helpers import is_port_open, load_scenario, scenario_lane_paths_for_trips, scenario_trip_specs
...
MOVEMENT_NAME = "south_to_west"
VEHICLE_ID = 1
MAX_STEPS = 900
WARMUP_STEPS = 0
TARGET_SPEED_MPS = 8.0
CAMERA_HEIGHT = 150
OUTPUT_DIR = ROOT_DIR / "V2V-Attack-Dataset/replay_records/roundabout/roundabout_scenario_01"
OUTPUT_NAME = "south_to_west.jsonl"
REUSE_METSR = False
...
def configure_run(scenario, lane_paths, target_speed_mps):
...
def main():
    ...
    trip_specs = scenario_trip_specs(scenario, (MOVEMENT_NAME,))
    lane_paths = scenario_lane_paths_for_trips(scenario, trip_specs)
    config = configure_run(scenario, lane_paths, TARGET_SPEED_MPS)
    ...
    try:
        ...
        meta = {
            "record_type": "roundabout_replay_bsm_trajectory",
