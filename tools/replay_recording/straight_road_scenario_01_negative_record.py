"""Record straight-road scenario 01 negative-direction movement as replayable BSM data."""
...
MOVEMENT_NAME = "negative"
VEHICLE_ID = 1
LANE_PATHS = {VEHICLE_ID: ["-38_4", "-12_4", "-34_4"]}
MAX_STEPS = 600
WARMUP_STEPS = 0
TARGET_SPEED_MPS = 10.0
CAMERA_HEIGHT = 350
OUTPUT_DIR = ROOT_DIR / "V2V-Attack-Dataset/replay_records/straight_road/straight_road_scenario_01"
OUTPUT_NAME = "negative.jsonl"
REUSE_METSR = False
...
def main():
    ...
    try:
        ...
        meta = {
            "record_type": "straight_road_replay_bsm_trajectory",
