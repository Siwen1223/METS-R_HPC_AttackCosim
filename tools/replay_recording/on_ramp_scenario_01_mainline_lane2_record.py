"""Record on-ramp scenario 01 mainline lane-2 movement as replayable BSM data."""
...
MOVEMENT_NAME = "mainline"
VEHICLE_ID = 1
LANE_PATHS = {VEHICLE_ID: ["-16_2", "-25_2", "-28_2", "-29#0_2"]}
MAX_STEPS = 600
WARMUP_STEPS = 0
TARGET_SPEED_MPS = 10.0
CAMERA_HEIGHT = 180
OUTPUT_DIR = ROOT_DIR / "V2V-Attack-Dataset/replay_records/on_ramp/on_ramp_scenario_01"
OUTPUT_NAME = "mainline_lane2.jsonl"
REUSE_METSR = False
