"""Record on-ramp scenario 01 ramp-to-mainline merging movement as replayable BSM data."""
...
MOVEMENT_NAME = "on_ramp"
VEHICLE_ID = 1
LANE_PATHS = {VEHICLE_ID: ["2_2", "45_2", "-29#0_2"]}
MAX_STEPS = 600
WARMUP_STEPS = 0
TARGET_SPEED_MPS = 10.0
CAMERA_HEIGHT = 180
OUTPUT_DIR = ROOT_DIR / "V2V-Attack-Dataset/replay_records/on_ramp/on_ramp_scenario_01"
OUTPUT_NAME = "ramp_merging.jsonl"
REUSE_METSR = False
...
def main():
    ...
    try:
        ...
        meta = {
            "record_type": "on_ramp_replay_bsm_trajectory",
