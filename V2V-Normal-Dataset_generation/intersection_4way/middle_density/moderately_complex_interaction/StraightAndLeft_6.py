"""Scenario 01 middle-density interaction: one direction straight and one direction left without attack."""
...
CASE_NAME = "StraightAndLeft_6_NoAttack"
...
MOVEMENT_NAMES = ("east_to_west", "east_to_west", "east_to_west", "south_to_west", "south_to_west", "south_to_west")
CAMERA_HEIGHT = 120
RANDOM_SEED = 42
